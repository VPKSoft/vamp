...
namespace vamp
{
    ...
    /// </summary>
    public partial class AmpMusicPlayerForm : DBLangEngineWinforms
    {
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="AmpMusicPlayerForm"/> class.
        /// </summary>
        public AmpMusicPlayerForm()
        {
            InitializeComponent(); // the generated code..

            DBLangEngine.DBName = "lang.sqlite"; // Do the VPKSoft.LangLib == translation
            DBLangEngine.AddNameSpace("ImageButton"); // no localization from a foreign name space..
        ...
        private void ClientConnect()
        {
            try
            {
                ...
                basicbinding.MaxReceivedMessageSize = int.MaxValue; // a lot of data transfer is expected as the album meta data is loaded..
        ...
        internal void SetButtonStates(PlayerState playerState)
        {
            ...
            btnPreviousSong.BackgroundImage =
                ...
                Properties.Resources.previous_disabled;
        ...
        private void mnuSelectAlbum_Click(object sender, EventArgs e)
        {
            ...
            if (ClientAction(() => { albumWCFs.AddRange(cli.GetAlbums()); }))
            {
                ...
                AlbumWCF album = SelectCustomContentDialog.Execute(albumWCFs, ((ToolStripMenuItem)sender).Text, "Name");
        ...
        private void mnuLoadSavedQueue_Click(object sender, EventArgs e)
        {
            ...
            if (ClientAction(() => { queueEntries.AddRange(cli.GetQueueList(playerState.CurrentAlbumName)); }))
            {
                if (queueEntries.Count > 0) // no reason to continue if there are no saved queues..
                {
                    ...
                    QueueEntry queueEntry = SelectCustomContentDialog.Execute(queueEntries, ((ToolStripMenuItem)sender).Text, "QueueName");
